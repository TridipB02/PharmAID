...
def create_chart_from_data(data: Dict[str, Any], chart_type: str = "bar") -> Optional[bytes]:
    """
...
def format_table_for_pdf(data: List[Dict[str, Any]], max_rows: int = 50) -> Optional[Table]:
    """
